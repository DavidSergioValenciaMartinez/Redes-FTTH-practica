...
<div class="container my-4">
    ...
    <form action="<?php echo URL_ROOT; ?>/instalaciones/crear<?php echo !empty($data['id_caja']) ? '/' . $data['id_caja'] : ''; ?>" method="POST" class="needs-validation" novalidate>
        ...
        <?php endif; ?>
        <div class="mb-3">
            <label for="id_tecnico" class="form-label">ID Técnico *</label>
            <input type="number" class="form-control" id="id_tecnico" name="id_tecnico" required>
            <div class="invalid-feedback">Ingrese el ID del técnico responsable.</div>
        </div>
        <div class="mb-3">

        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo URL_ROOT; ?>/user/create" class="btn btn-light">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 text-end">
                            <?php if (isset($showInactive) && $showInactive): ?>
                                <a href="<?php echo URL_ROOT; ?>/user" class="btn btn-outline-secondary">
                                    <i class="bi bi-eye"></i> Mostrar solo activos
                                </a>
                            <?php else: ?>
                                <a href="<?php echo URL_ROOT; ?>/user?includeInactive=1" class="btn btn-outline-secondary">
                                    ...
                                    <tr class="<?php echo $status == 'Inactivo' ? 'table-danger' : ''; ?>">
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="<?php echo URL_ROOT; ?>/user/verDetalle?id=<?php echo $id; ?>" 
                                                   class="btn btn-info" title="Ver detalles">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="<?php echo URL_ROOT; ?>/user/edit?id=<?php echo $id; ?>" 

...
class Asignacion extends Model {
    ...
    public function obtenerTodas() {
        $sql = 'SELECT a.*, c.id_cliente FROM ' . $this->table . ' a INNER JOIN tbl_clientes c ON a.id_cliente = c.id_cliente ORDER BY a.fecha_asignacion DESC';
    ...
    public function obtenerPorId($id) {
        $sql = 'SELECT a.*, c.id_cliente FROM ' . $this->table . ' a INNER JOIN tbl_clientes c ON a.id_cliente = c.id_cliente WHERE a.id_asignacion = :id';
        $stmt = $this->prepare($sql);

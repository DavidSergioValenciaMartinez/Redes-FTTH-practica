...
class Router {
    ...
    private static $routes = [
        ...
        '/catalogo/crear' => ['controller' => 'CatalogoController', 'action' => 'crear'],
        ...
        '/cajas_nap/grafica' => ['controller' => 'CajaNapController', 'action' => 'grafica'],
        ...
        '/speedtest' => ['controller' => 'SpeedtestController', 'action' => 'index'],
    ];

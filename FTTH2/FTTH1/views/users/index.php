                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="btn-group" role="group">
                                <a href="<?php echo URL_ROOT; ?>/users" class="btn btn-outline-primary">Todos</a>
                                <a href="<?php echo URL_ROOT; ?>/users/by-role?role=admin" class="btn btn-outline-primary">Administradores</a>
                                <a href="<?php echo URL_ROOT; ?>/users/by-role?role=technician" class="btn btn-outline-primary">Técnicos</a>
                                <a href="<?php echo URL_ROOT; ?>/users/by-role?role=client" class="btn btn-outline-primary">Clientes</a>
                            </div>
                        </div>
                                    ...
                                    <tr class="<?php echo $status == 'Inactivo' ? 'table-danger' : ''; ?>">
                                        ...
                                        <td>
                                            <?php if (!empty($user['fotografia'])): ?>
                                                <img src="<?php echo URL_ROOT . $user['fotografia']; ?>" alt="Foto" style="width:40px; height:40px; object-fit:cover; border-radius:50%; border:1px solid #ccc;">
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <?php echo !empty($user['fecha_nacimiento']) ? date('d/m/Y', strtotime($user['fecha_nacimiento'])) : '<span class="text-muted">-</span>'; ?>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <?php if (isset($_SESSION['user_email']) && $_SESSION['user_email'] === 'admin@solufiber-srl.com' && $role !== 'Administrador'): ?>
                                                ...
                                                <?php if ($status == 'Activo'): ?>
                                                    <a href="<?php echo URL_ROOT; ?>/users/delete?id=<?php echo $id; ?>" 
                                                       class="btn btn-danger" title="Inactivar usuario"

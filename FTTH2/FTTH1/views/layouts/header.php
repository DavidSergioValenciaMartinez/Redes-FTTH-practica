    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top shadow-sm">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo URL_ROOT; ?>">
                <img id="logo-solufiber" src="<?php echo URL_ROOT; ?>/public/img/Solufiber-01.png" alt="Logo Solufiber" style="height:48px; width:auto;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if (isset($_SESSION['user_role']) && in_array($_SESSION['user_role'], ['tecnico', 'admin', 'technician', 'cliente', 'client'])): ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo (isset($active_page) && in_array($active_page, ['balanceados','desbalanceados'])) ? 'active' : ''; ?>" href="#" id="calculoDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-calculator me-1"></i> Verificación de Red
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="calculoDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo URL_ROOT; ?>/speedtest"><i class="fas fa-tachometer-alt me-1"></i> Speedtest</a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <!-- Botón de Asignaciones eliminado -->
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo (isset($active_page) && in_array($active_page, ['departamentos','cajas_nap','puertos','instalaciones'])) ? 'active' : ''; ?>" href="#" id="gestionDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-cogs me-1"></i> Soporte
                        </a>
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center px-3" style="min-width: 140px; justify-content: center;" href="<?php echo URL_ROOT; ?>/noticias">
...
document.addEventListener('DOMContentLoaded', function() {
    function updateLogo() {
        var logo = document.getElementById('logo-solufiber');
    ...
    document.getElementById('toggleStyle').addEventListener('click', function() {
        setTimeout(updateLogo, 100); // Espera a que cambie la clase
    });
});
</script>
